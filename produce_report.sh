...
FABRIC_PATH="$HOME/Fabric/fabric" # Define path to fabric executable
...
echo "Running Personality Analysis..."
{
    ...
    echo "================================================="
    cat "$DATA_FILE" | grep -v "\n" | "$FABRIC_PATH" -sp analyze_personality
    echo -e "\n\n"
} >> "$REPORT_FILE"
...
echo "Describing Life Outlook..."
{
    ...
    echo "                 LIFE OUTLOOK"
    echo "================================================="
    cat "$DATA_FILE" |grep -v "\n" | "$FABRIC_PATH" -sp t_describe_life_outlook
    echo -e "\n\n"
} >> "$REPORT_FILE"
...
echo "Extracting Key Insights..."
{
    ...
    echo "================================================="
    cat "$DATA_FILE" |grep -v "\n"| "$FABRIC_PATH" -sp extract_insights
    echo -e "\n\n"
} >> "$REPORT_FILE"
...
echo "Analyzing Writing Style..."
{
    ...
    echo "================================================="
    cat "$DATA_FILE" |grep -v "\n"| "$FABRIC_PATH" -sp analyze_prose_pinker
    echo -e "\n\n"
} >> "$REPORT_FILE"
